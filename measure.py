...
ens210 = RTrobot_ENS210.RTrobot_ENS210()
...
ens160 = RTrobot_ENS160.RTrobot_ENS160(mode=ENS160_MODE_I2C, spi_cs=8)
...
ltr390 = RTrobot_LTR390UV.RTrobot_LTR390UV()
buf390 = ltr390.LTR390UV_Init()

#每600秒进行一次repeat操作
def createTimer():
    t = threading.Timer(600, repeat)
    t.start()
...
def printData2():
    ...
    print("AQI:%d\tTVOC:%dppb\teCO2:%dppm\r\n" % (ens160._data_aqi, ens160._data_tvoc, ens160._data_eco2))
    time.sleep(1)
